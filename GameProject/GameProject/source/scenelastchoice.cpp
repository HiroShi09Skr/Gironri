...
void SceneLastChoice::Draw()
{
	...
	//int CorrectEffectspeed = 2; //画面破壊エフェクトの速さ
	//if (CorrectEffectflg == 1) {
	//	//フラッシュ
	//	SetDrawBlendMode(DX_BLENDMODE_ALPHA, 50 * CorrectEffectnum);
	//	DrawBox(0, 0, SCREEN_W, SCREEN_H, GetColor(255, 255, 255), TRUE);
	//	SetDrawBlendMode(DX_BLENDMODE_NOBLEND, 0);
	//	DrawGraph(0, _jsonData[messagecnt].bgY, cgCorrectEffect[CorrectEffectcnt / CorrectEffectspeed], TRUE); //背景
	//	SetDrawBlendMode(DX_BLENDMODE_ALPHA, 50 * (CorrectEffectnum - 1));
	//	DrawBox(0, 0, SCREEN_W, SCREEN_H, GetColor(255, 255, 255), TRUE);
	//	SetDrawBlendMode(DX_BLENDMODE_NOBLEND, 0);
	//	CorrectEffectcnt++;
	//	if (CorrectEffectcnt > 15 * CorrectEffectspeed) {
	//		CorrectEffectflg = 0;
	//	}
	//}
	//else
	...
	//DrawFormatString(1300, 700, GetColor(255, 255, 255), "messagecnt：%d", messagecnt); 
	//DrawFormatString(1300, 800, GetColor(255, 255, 255), "_jsonData[messagecnt].command：%d", _jsonData[messagecnt].command);
	//DrawFormatString(1300, 900, GetColor(255, 255, 255), "CorrectEffectnum：%d", CorrectEffectnum);
	//DrawFormatString(0, 600, GetColor(255, 255, 255), "drawCnt1：%d", drawCnt1);
	// カラーマスクのフェードインアウト描画
	ColorFadeDraw();
}
