...
void FrameDraw() {
	...
	//DrawFormatString(0, 200, GetColor(255, 255, 255), "A：次のシーンへ");
	//DrawFormatString(0, 300, GetColor(255, 255, 255), "B：次のセリフ・防御");
	//DrawFormatString(0, 400, GetColor(255, 255, 255), "X：反論パート");
