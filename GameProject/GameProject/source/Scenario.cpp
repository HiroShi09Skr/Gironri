...
{
	//画像
	cgWord = LoadGraph("res/cards/giron_card11.png");
}
Scenario::~Scenario()
{
...
void Scenario::SetChapterScenario(int chapter) {
	// 証言者番号,	証言カウント,		出現タイミング,	出現位置x,y,	言葉の種類,	画像名,	出現後から動き出す時間,	音声名
	...
	/*
	// 罵詈雑言：緑2「黒崎さんも可哀想に」
	{ 0, 2,  600, gikai[1].X - 480, gikai[1].Y + 250,1, cgGreenThoughtlessWords[chapter][1][0],  70, seRough},
	{ 0, 2,  610, gikai[1].X - 360, gikai[1].Y + 280,1, cgGreenThoughtlessWords[chapter][1][1],  75},
	{ 0, 2,  620, gikai[1].X - 240, gikai[1].Y + 250,1, cgGreenThoughtlessWords[chapter][1][2],  80},
	{ 0, 2,  630, gikai[1].X - 120, gikai[1].Y + 270,1, cgGreenThoughtlessWords[chapter][1][3],  85},
	{ 0, 2,  640, gikai[1].X      , gikai[1].Y + 250,1, cgGreenThoughtlessWords[chapter][1][4],  90},
	{ 0, 2,  650, gikai[1].X + 120, gikai[1].Y + 250,1, cgGreenThoughtlessWords[chapter][1][5],  95},
	{ 0, 2,  660, gikai[1].X + 240, gikai[1].Y + 280,1, cgGreenThoughtlessWords[chapter][1][6], 100},
	{ 0, 2,  670, gikai[1].X + 360, gikai[1].Y + 250,1, cgGreenThoughtlessWords[chapter][1][7], 105},
	{ 0, 2,  680, gikai[1].X + 480, gikai[1].Y + 270,1, cgGreenThoughtlessWords[chapter][1][8], 110},
	{ 0, 2,  690, gikai[1].X + 600, gikai[1].Y + 250,1, cgGreenThoughtlessWords[chapter][1][9], 115},

	// 罵詈雑言：黄2「まさか本当だったとは」
	{ 0, 2, 1000, gikai[2].X - 600, gikai[2].Y + 250,1, cgYellowThoughtlessWords[chapter][1][0],  70, seRough},
	{ 0, 2, 1010, gikai[2].X - 480, gikai[2].Y + 250,1, cgYellowThoughtlessWords[chapter][1][1],  75,},
	{ 0, 2, 1020, gikai[2].X - 360, gikai[2].Y + 250,1, cgYellowThoughtlessWords[chapter][1][2],  85},
	{ 0, 2, 1030, gikai[2].X - 240, gikai[2].Y + 270,1, cgYellowThoughtlessWords[chapter][1][3],  90},
	{ 0, 2, 1040, gikai[2].X - 120, gikai[2].Y + 250,1, cgYellowThoughtlessWords[chapter][1][4],  95},
	{ 0, 2, 1050, gikai[2].X      , gikai[2].Y + 250,1, cgYellowThoughtlessWords[chapter][1][5],  100},
	{ 0, 2, 1060, gikai[2].X + 120, gikai[2].Y + 280,1, cgYellowThoughtlessWords[chapter][1][6],  105},
	{ 0, 2, 1070, gikai[2].X + 240, gikai[2].Y + 250,1, cgYellowThoughtlessWords[chapter][1][7],  110},
	{ 0, 2, 1080, gikai[2].X + 360, gikai[2].Y + 270,1, cgYellowThoughtlessWords[chapter][1][8],  115},
	{ 0, 2, 1090, gikai[2].X + 480, gikai[2].Y + 250,1, cgYellowThoughtlessWords[chapter][1][9],  120},

	// 罵詈雑言：青2「早く消えてください」
	{ 0, 2, 1450, gikai[3].X - 120, gikai[3].Y + 250,1, cgBlueThoughtlessWords[chapter][1][5],  100},
	{ 0, 2, 1460, gikai[3].X      , gikai[3].Y + 280,1, cgBlueThoughtlessWords[chapter][1][6],  105},
	{ 0, 2, 1470, gikai[3].X + 120, gikai[3].Y + 250,1, cgBlueThoughtlessWords[chapter][1][7],  110},
	{ 0, 2, 1480, gikai[3].X + 240, gikai[3].Y + 270,1, cgBlueThoughtlessWords[chapter][1][8],  115},

	// 罵詈雑言：ピンク1「よく顔を見せられたね」
	{ 0, 2, 1600, gikai[4].X - 960, gikai[4].Y + 250,1, cgPinkThoughtlessWords[chapter][0][0],  70, seRough},
	{ 0, 2, 1610, gikai[4].X - 840, gikai[4].Y + 250,1, cgPinkThoughtlessWords[chapter][0][1],  75,},
	{ 0, 2, 1620, gikai[4].X - 720, gikai[4].Y + 250,1, cgPinkThoughtlessWords[chapter][0][2],  85},
	{ 0, 2, 1630, gikai[4].X - 600, gikai[4].Y + 270,1, cgPinkThoughtlessWords[chapter][0][3],  90},
	{ 0, 2, 1640, gikai[4].X - 480, gikai[4].Y + 250,1, cgPinkThoughtlessWords[chapter][0][4],  95},
	{ 0, 2, 1650, gikai[4].X - 360, gikai[4].Y + 250,1, cgPinkThoughtlessWords[chapter][0][5],  100},
	{ 0, 2, 1660, gikai[4].X - 240, gikai[4].Y + 280,1, cgPinkThoughtlessWords[chapter][0][6],  105},
	{ 0, 2, 1670, gikai[4].X - 120, gikai[4].Y + 250,1, cgPinkThoughtlessWords[chapter][0][7],  110},
	{ 0, 2, 1680, gikai[4].X      , gikai[4].Y + 270,1, cgPinkThoughtlessWords[chapter][0][8],  115},
	{ 0, 2, 1690, gikai[4].X + 120, gikai[4].Y + 250,1, cgPinkThoughtlessWords[chapter][0][9],  120},

	// 罵詈雑言：ピンク2「貴女が１番の悪じゃん」
	{ 0, 2, 1870, gikai[4].X - 120, gikai[4].Y + 250,1, cgPinkThoughtlessWords[chapter][1][7],  110},
	{ 0, 2, 1880, gikai[4].X	   , gikai[4].Y + 270,1,cgPinkThoughtlessWords[chapter][1][8],  115},
	{ 0, 2, 1890, gikai[4].X + 120, gikai[4].Y + 250,1, cgPinkThoughtlessWords[chapter][1][9],  120},
	*/
	...
	//{ 3, 2, 90, gikai[3].X + 120, gikai[3].Y + 250,1, cgBlueThoughtlessWords[chapter][1][8],  50},
	...
	//{ 0, 2,  945, gikai[0].X + 840, gikai[0].Y + 280,1, cgRedThoughtlessWords[chapter][0][9],  120},
	...
	//{ 4, 2,  890, gikai[4].X , gikai[4].Y + 250,1, cgPinkThoughtlessWords[chapter][2][4],  15 },
	...
	//（言葉が出）てこ（ないのね）
	//{ 0, 2, 290, gikai[0].X + 240, gikai[0].Y + 250,1, cgRedThoughtlessWords[chapter][1][4],  90},
	//{ 0, 2, 300, gikai[0].X + 360, gikai[0].Y + 280,1, cgRedThoughtlessWords[chapter][1][5],  95},

	//あまりに(現実味がない)
	/*{ 3, 2, 1475, gikai[3].X - 840, gikai[3].Y + 250,1, cgBlueThoughtlessWords[chapter][1][0],  20, seBlueLaugh },
	{ 3, 2, 1477, gikai[3].X - 720, gikai[3].Y + 250,1, cgBlueThoughtlessWords[chapter][1][1],  18 },
	{ 3, 2, 1479, gikai[3].X - 600, gikai[3].Y + 250,1, cgBlueThoughtlessWords[chapter][1][2],  16 },
	{ 3, 2, 1481, gikai[3].X - 480, gikai[3].Y + 270,1, cgBlueThoughtlessWords[chapter][1][3],  14 },
	*/

	//（あんたもおわりだ）よ
	//{ 4, 2, 2080, gikai[4].X + 360, gikai[4].Y + 250,1, cgPinkThoughtlessWords[chapter][0][8], 115},
	...
	int i = 0;
	//チャプターに応じたシナリオの中身を入れる
	switch (chapter)
	{
	case 0:
		while (scenario0[i].gamecnt != -2) {	// データの最後までをループ

			scenarioList.push_back(scenario0[i]);
			i++;
		}
		break;

	case 1:
		while (scenario1[i].gamecnt != -2) {	// データの最後までをループ

			scenarioList.push_back(scenario1[i]);
			i++;
		}
		break;
	case 2:
		while (scenario2[i].gamecnt != -2) {	// データの最後までをループ

			scenarioList.push_back(scenario2[i]);
			i++;
		}
		break;
	case 3:
		while (scenario3[i].gamecnt != -2) {	// データの最後までをループ

			scenarioList.push_back(scenario3[i]);
			i++;
		}
		break;
	case 4:
		while (scenario4[i].gamecnt != -2) {	// データの最後までをループ

			scenarioList.push_back(scenario4[i]);
			i++;
		}
		break;
	case 5:
		while (scenario5[i].gamecnt != -2) {	// データの最後までをループ

			scenarioList.push_back(scenario5[i]);
			i++;
		}
		break;
	default:
