...
void SceneTalk::Draw()
{
	...
	if (popupflg == 1) {
		...
		{
			//DrawGraph(960 -550, 420 -300, cg_popup, TRUE);
		}
		DrawRotaGraph(960, 420, popup_size, 0, cg_popup, TRUE);
	}
	...
	//DrawFormatString(1300, 800, GetColor(255, 255, 255), "_jsonData[messagecnt + selectcnt].command：%d", _jsonData[messagecnt + selectcnt].command);
	//DrawFormatString(0, 900, GetColor(255, 255, 255), "150 + log_y：%d", 150 + log_y);
	//DrawFormatString(0, 600, GetColor(255, 255, 255), "150 + log_y：%d", 150 + log_y);
}
